...
TOPIC_LIVEKIT_CHAT = os.getenv("KAFKA_CHAT_TOPIC", "conference.chat")
...
TOPIC_TRANSCRIPT_VOICE = os.getenv("KAFKA_TRANSCRIPT_TOPIC", "conference.transcript.voice")
TOPIC_TRANSCRIPT_VOICE_LEGACY = os.getenv("TOPIC_TRANSCRIPT_VOICE_LEGACY", "conference.transcript.voice")
